      ...
      <main className="flex-grow pt-20">
        ...
        <section className="bg-gradient-to-r from-primary to-primary-container py-20 px-6 text-white">
          <div className="max-w-[1200px] mx-auto text-center animate-fade-in-up">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Obtenez votre devis gratuit pour l'entretien de climatisation !</h1>
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Installation, réparation et maintenance de systèmes de climatisation professionnels
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="animate-fade-in-down">
                <div className="bg-gradient-to-br from-primary/10 to-primary-container/10 rounded-2xl p-8 border border-primary/20">
                  <h3 className="text-2xl font-bold text-on-surface mb-6">Pourquoi Taoman Groupe ?</h3>
