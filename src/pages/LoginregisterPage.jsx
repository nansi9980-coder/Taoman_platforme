...
export const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/'); // Rediriger vers l'accueil puisqu'il n'y a pas de dashboard côté client
      }, 1000);
    } catch (err) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      <Header activeLink="connexion" />

      <main className="flex-grow pt-20 px-6 py-12">
        <div className="max-w-md mx-auto">
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-outline-variant/20 animate-fade-in">
            ...
            <p className="text-center text-on-surface-variant mb-8">Accédez à votre compte Taoman</p>
...
export const RegisterPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      <Header activeLink="inscription" />

      <main className="flex-grow pt-20 px-6 py-12">
        <div className="max-w-md mx-auto">
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-outline-variant/20 animate-fade-in">
            <h1 className="text-3xl font-bold text-on-surface text-center mb-2">S'inscrire</h1>
            <p className="text-center text-on-surface-variant mb-8">Créez votre compte Taoman</p>
