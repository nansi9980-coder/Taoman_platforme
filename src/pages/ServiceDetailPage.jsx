  ...
  if (!service) {
    return (
      <div className="min-h-screen bg-surface flex items-center justify-center px-6 py-20">
        <p className="text-on-surface-variant">Chargement du service...</p>
      </div>
    );
  }
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white rounded-3xl p-8 shadow-lg animate-fade-in-up">
                <h2 className="text-3xl font-bold text-on-surface mb-6">Détails du service</h2>
              ...
              <div className="bg-gradient-to-br from-primary/10 to-primary-container/10 rounded-3xl p-8 border border-primary/20 animate-fade-in-up">
                <h3 className="text-2xl font-bold text-on-surface mb-4">Informations clés</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <span className="text-primary text-2xl">📍</span>
                    <div>
                      <p className="text-on-surface font-bold">Localisation</p>
                  ...
                  <div className="flex items-start gap-4">
                    <span className="text-primary text-2xl">✅</span>
                    <div>
                      <p className="text-on-surface font-bold">Disponibilité</p>
                      <p className="text-on-surface-variant">Disponible 24/7</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <aside className="space-y-8">
              <div className="bg-white rounded-3xl p-8 shadow-lg animate-fade-in-up">
                <h3 className="text-2xl font-bold text-on-surface mb-6">Caractéristiques</h3>
              ...
              <div className="bg-gradient-to-br from-primary/10 to-primary-container/10 rounded-3xl p-8 border border-primary/20 shadow-lg animate-fade-in-up">
                <h3 className="text-2xl font-bold text-on-surface mb-6">Contact rapide</h3>
                <p className="text-on-surface-variant mb-4">Pour toute question directe sur ce service, contactez notre équipe dès maintenant.</p>
                <button
